...
public class BingoImage {
    ...
    protected BingoImage(int Xposition, int Yposition, int width, int high, String IMAGE_FILE_NAME, JPanel bingoPanel){
        ...
        bingoPanel.add(imageLabel);
    }
    protected BingoImage(int Xposition, int Yposition, int width, int high, String IMAGE_FILE_NAME, JPanel bingoPanel, int zOrder){
        this.IMAGE_ABSOLUTE_PATH = Main.getAbsolutePathToDirImg() + "\\" + IMAGE_FILE_NAME;
        this.imageLabel.setBounds(Xposition, Yposition, width, high);
        bingoPanel.add(imageLabel);
    ...
    protected BingoImage(int Xposition, int Yposition, int width, int high, String IMAGE_FILE_NAME, JPanel bingoPanel, boolean visible){
        this.IMAGE_ABSOLUTE_PATH = Main.getAbsolutePathToDirImg() + "\\" + IMAGE_FILE_NAME;
        this.imageLabel.setBounds(Xposition, Yposition, width, high);
        bingoPanel.add(imageLabel);
